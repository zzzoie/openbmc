...
def setup_common_routes(app):
    ...
    app.router.add_get(common_routes[7], chandler.rest_fcpresent_hdl)
    app.router.add_get(common_routes[8], chandler.psu_update_hdl)
    app.router.add_post(common_routes[8], chandler.psu_update_hdl_post)
    app.router.add_get(common_routes[9], chandler.rest_mTerm_status)
